    ...
    <div className="w-full">
      ...
      <div className="flex border-b border-slate-200 dark:border-white/10 mb-6 bg-white dark:bg-[#0f172a] rounded-t-2xl overflow-hidden shadow-sm">
        <button
          ...
          className={`flex-1 py-4 px-6 flex items-center justify-between transition-all border-b-[3px] ${activeTab === 'join'
        ...
        <button
          ...
          className={`flex-1 py-4 px-6 flex items-center justify-between transition-all border-b-[3px] ${activeTab === 'create'
              ? 'border-[#0ea5e9] bg-[#0ea5e9]/5'
              : 'border-transparent text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5'
            }`}
        >
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full border text-[13px] font-bold transition-all ${createForm.businessType === 'ENTERPRISE'
                ...
                >
                  <div className={`w-4 h-4 rounded-full border-[1.5px] flex items-center justify-center ${createForm.businessType === 'ENTERPRISE' ? 'border-[#0ea5e9]' : 'border-slate-300 dark:border-slate-600'
                    }`}>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full border text-[13px] font-bold transition-all ${createForm.businessType === 'HOUSEHOLD'
                      ? 'border-[#0ea5e9] text-[#0ea5e9] bg-[#0ea5e9]/5'
                      : 'border-slate-200 dark:border-white/10 text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5'
                    }`}
                >
                  <div className={`w-4 h-4 rounded-full border-[1.5px] flex items-center justify-center ${createForm.businessType === 'HOUSEHOLD' ? 'border-[#0ea5e9]' : 'border-slate-300 dark:border-slate-600'
                    }`}>
