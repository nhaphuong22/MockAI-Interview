    ...
    <div className="space-y-6">
      ...
      <div className="dark:bg-[#0f172a] bg-white rounded-2xl shadow-sm border dark:border-white/10 border-gray-100 p-6">
        ...
        <div className="space-y-3">
          <button className="w-full px-4 py-3 dark:bg-[#1e293b] bg-[#f0f9ff] text-[#0ea5e9] font-semibold rounded-xl hover:bg-[#0ea5e9] hover:text-white transition-all flex items-center gap-2">
            <Briefcase className="w-5 h-5" />
            <span>AI Phỏng Vấn Thử</span>
          </button>
          <button className="w-full px-4 py-3 border-2 dark:border-white/10 dark:text-slate-300 dark:hover:bg-white/10 border-gray-200 font-semibold rounded-xl hover:border-[#0ea5e9] dark:hover:border-[#0ea5e9] hover:bg-[#f0f9ff] hover:text-[#0ea5e9] dark:hover:text-[#0ea5e9] transition-all flex items-center gap-2">
