    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href="#"
            className="flex items-center gap-2 px-4 py-2 dark:bg-[#1e293b] dark:text-slate-300 dark:hover:bg-[#0ea5e9]/10 bg-gray-100 hover:bg-[#f0f9ff] hover:text-[#0ea5e9] rounded-xl transition-all"
          >
