        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              <div className="flex items-start gap-6 mb-6">
                <div className="w-20 h-20 bg-gradient-to-br from-[#0ea5e9] to-[#38bdf8] rounded-2xl flex items-center justify-center text-4xl flex-shrink-0">
                  {job.logo}
                </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="flex items-center gap-2 px-4 py-2 border-2 border-gray-200 rounded-xl hover:border-[#0ea5e9] hover:bg-[#f0f9ff] transition-all">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <div className="flex flex-wrap gap-3">
                {job.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-4 py-2 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl"
                  >
                    {tag}
                  </span>
                ))}
                <span className="px-4 py-2 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl">HTML5</span>
                <span className="px-4 py-2 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl">CSS3</span>
                <span className="px-4 py-2 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl">Redux</span>
                <span className="px-4 py-2 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl">Git</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="font-semibold text-[#0ea5e9]">{job.salary}</div>
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <Link
                to="/company/1"
                className="block text-center py-2 border-2 border-gray-200 rounded-xl hover:border-[#0ea5e9] hover:bg-[#f0f9ff] hover:text-[#0ea5e9] transition-all"
              >
                Xem trang công ty
              </Link>
            </div>
