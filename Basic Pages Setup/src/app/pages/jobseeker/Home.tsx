...
const popularTags = ["IT", "Marketing", "Design", "Finance", "Sales", "HR"];
...
export function Home() {
  return (
    <div>
      <section className="bg-gradient-to-br from-white via-[#FFF3ED] to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mb-8">
            <div className="bg-white rounded-2xl shadow-xl p-4 flex flex-col md:flex-row gap-3">
              ...
              <Link
                to="/jobs"
                className="px-8 py-3 bg-gradient-to-r from-[#E8580C] to-[#ff7a3d] text-white rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="flex flex-wrap gap-2 mt-4 justify-center">
              {popularTags.map((tag) => (
                <button
                  key={tag}
                  className="px-4 py-1.5 bg-white border border-gray-200 rounded-full text-sm hover:border-[#E8580C] hover:bg-[#FFF3ED] hover:text-[#E8580C] transition-all"
                >
                  {tag}
                </button>
              ))}
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-[#FFF3ED] rounded-xl mb-3">
                    <Icon className="w-6 h-6 text-[#E8580C]" />
                  </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              to="/jobs"
              className="flex items-center gap-2 text-[#E8580C] hover:gap-3 transition-all"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredJobs.map((job) => (
              <div
                key={job.id}
                className="bg-white rounded-2xl p-6 border-2 border-gray-100 hover:border-[#E8580C] hover:shadow-lg transition-all cursor-pointer group"
              >
                {job.hot && (
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 group-hover:text-[#E8580C] transition-colors">
                      {job.title}
                    </h3>
                ...
                <div className="flex items-center gap-2 text-sm text-[#E8580C] font-semibold mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] text-white rounded-2xl text-2xl mb-4">
                1
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl mb-4">Bắt đầu hành trình ngay hôm nay</h2>
          <p className="text-xl opacity-90 mb-8">
            Hơn 200,000 ứng viên đã tìm được công việc mơ ước với JobBridge
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="px-8 py-4 bg-white text-[#E8580C] rounded-xl hover:shadow-2xl hover:scale-105 transition-all"
            >
              Đăng Ký Miễn Phí
            </Link>
            <Link
              to="/jobs"
              className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-xl hover:bg-white hover:text-[#E8580C] transition-all"
            >
              Khám Phá Việc Làm
            </Link>
          </div>
