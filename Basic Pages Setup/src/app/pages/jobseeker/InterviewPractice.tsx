...
export function InterviewPractice() {
  const [mode, setMode] = useState<"select" | "practicing" | "feedback">("select");
  const [currentQuestion, setCurrentQuestion] = useState(0);
  const [interviewType, setInterviewType] = useState<"text" | "voice" | null>(null);

  const startInterview = (type: "text" | "voice") => {
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="max-w-3xl w-full">
            <div className="bg-white rounded-2xl p-8 mb-6 text-center">
              <div className="text-sm text-[#E8580C] mb-2">Câu Hỏi {currentQuestion + 1}</div>
              ...
              <div className="bg-white rounded-2xl p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="text-sm text-gray-600">
                    <span className="text-[#E8580C] font-semibold">Gợi ý:</span> Sử dụng phương pháp STAR
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100">
              <div className="text-4xl mb-2 text-[#E8580C]">85</div>
                ...
                <div key={index} className="border-b border-gray-200 pb-6 last:border-0">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4">
                    <p className="text-sm text-gray-700">
                      ...
                      <br />
                      💡 Có thể cải thiện: Thêm metrics định lượng để câu trả lời thuyết phục hơn.
                    </p>
                  </div>
                </div>
              ))}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div
            ...
            className="bg-white rounded-2xl p-8 shadow-sm border-2 border-gray-100 hover:border-[#E8580C] hover:shadow-lg transition-all cursor-pointer group"
          >
            <div className="w-16 h-16 bg-[#FFF3ED] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <MessageCircle className="w-8 h-8 text-[#E8580C]" />
            </div>
            ...
            <div className="flex items-center gap-2 text-[#E8580C]">
          ...
          >
            <div className="w-16 h-16 bg-[#FFF3ED] rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <Mic className="w-8 h-8 text-[#E8580C]" />
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
              {previousSessions.map((session) => (
                <div
                  key={session.id}
                  className="flex items-center gap-6 p-4 border border-gray-200 rounded-xl hover:border-[#E8580C] transition-colors"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] rounded-xl flex items-center justify-center text-white font-semibold">
                    {session.score}
                  </div>
                  <div className="flex-1">
