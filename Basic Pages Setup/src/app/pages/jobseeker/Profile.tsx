    ...
    <div className="bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
          <div className="h-48 bg-gradient-to-r from-[#E8580C] to-[#ff7a3d] relative">
          ...
          <div className="px-8 pb-8">
            <div className="flex flex-col md:flex-row gap-6 -mt-20 relative">
              <div className="w-40 h-40 rounded-2xl bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] ring-4 ring-white flex items-center justify-center text-6xl flex-shrink-0">
                👨‍💻
              </div>
              ...
              <div className="flex-1 pt-24 md:pt-0 md:mt-20">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                  ...
                  <div className="flex gap-3">
                    <button className="px-4 py-2 border-2 border-gray-300 rounded-xl hover:border-[#E8580C] hover:bg-[#FFF3ED] hover:text-[#E8580C] transition-all flex items-center gap-2">
                      <Edit className="w-4 h-4" />
                      <span>Chỉnh Sửa</span>
                    </button>
                    <button className="px-4 py-2 bg-gradient-to-r from-[#E8580C] to-[#ff7a3d] text-white rounded-xl hover:shadow-lg transition-all flex items-center gap-2">
                      <Download className="w-4 h-4" />
                      <span>Tải CV</span>
                    </button>
                    <button className="p-2 border-2 border-gray-300 rounded-xl hover:border-[#E8580C] hover:bg-[#FFF3ED] hover:text-[#E8580C] transition-all">
                ...
                <div className="bg-[#FFF3ED] rounded-xl p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-sm font-semibold text-[#E8580C]">85%</span>
                  </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-6">
            <Tabs.Root defaultValue="about" className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              <Tabs.List className="flex border-b border-gray-200">
                <Tabs.Trigger
                  value="about"
                  className="flex-1 px-6 py-4 text-gray-600 hover:text-[#E8580C] data-[state=active]:text-[#E8580C] data-[state=active]:border-b-2 data-[state=active]:border-[#E8580C] transition-colors"
                >
                  Giới Thiệu
                </Tabs.Trigger>
                <Tabs.Trigger
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      <a
                        href="#"
                        className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-[#FFF3ED] hover:text-[#E8580C] rounded-xl transition-all"
                      >
                ...
                <div className="space-y-6">
                  {experiences.map((exp, index) => (
                    <div key={index} className="flex gap-4 pb-6 border-b border-gray-200 last:border-0">
                      <div className="w-12 h-12 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] rounded-xl flex items-center justify-center text-2xl flex-shrink-0">
                        {exp.logo}
                      </div>
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold mb-1">{exp.title}</h3>
                        <p className="text-[#E8580C] mb-2">{exp.company}</p>
                    ...
                    <div key={index}>
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs px-2 py-0.5 bg-[#FFF3ED] text-[#E8580C] rounded-full">
                            {skill.category}
                          </span>
                        </div>
              ...
              <Tabs.Content value="achievements" className="p-6">
                <div className="space-y-4">
                  {achievements.map((achievement, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-4 p-4 border-2 border-gray-100 rounded-xl hover:border-[#E8580C] transition-all"
                    >
                      <div className="w-12 h-12 bg-[#FFF3ED] rounded-xl flex items-center justify-center flex-shrink-0">
                        <Award className="w-6 h-6 text-[#E8580C]" />
                      </div>
                      <div className="flex-1">
                  ...
                  <button className="w-full py-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-600 hover:border-[#E8580C] hover:text-[#E8580C] hover:bg-[#FFF3ED] transition-all">
                    + Thêm Thành Tích
                  </button>
                </div>
              </Tabs.Content>
          ...
          <div className="space-y-6">
              ...
              <div className="relative w-32 h-32 mx-auto mb-4">
                <svg className="w-32 h-32 transform -rotate-90">
                  ...
                  <defs>
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
                      <stop offset="0%" stopColor="#E8580C" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-3xl text-[#E8580C]">88</div>
            ...
            <div className="bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] rounded-2xl p-6 text-white">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                <button className="w-full px-4 py-3 bg-[#FFF3ED] text-[#E8580C] rounded-xl hover:bg-[#E8580C] hover:text-white transition-all flex items-center gap-2">
                  <Briefcase className="w-5 h-5" />
                  <span>AI Phỏng Vấn Thử</span>
                </button>
                <button className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-[#E8580C] hover:bg-[#FFF3ED] hover:text-[#E8580C] transition-all flex items-center gap-2">
