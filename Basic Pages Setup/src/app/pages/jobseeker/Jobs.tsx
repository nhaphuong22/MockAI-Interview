      ...
      >
        <div className="p-6 space-y-6 h-full overflow-y-auto">
          ...
          <Collapsible.Root defaultOpen>
            <Collapsible.Trigger className="flex items-center justify-between w-full py-2 hover:text-[#E8580C] transition-colors">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-sm text-[#E8580C]">
            ...
            >
              <Slider.Track className="bg-gray-200 relative grow rounded-full h-1.5">
                <Slider.Range className="absolute bg-gradient-to-r from-[#E8580C] to-[#ff7a3d] rounded-full h-full" />
              </Slider.Track>
              <Slider.Thumb className="block w-5 h-5 bg-white border-2 border-[#E8580C] rounded-full hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#E8580C] transition-transform" />
              <Slider.Thumb className="block w-5 h-5 bg-white border-2 border-[#E8580C] rounded-full hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#E8580C] transition-transform" />
            </Slider.Root>
          </div>
          ...
          <button className="w-full py-2 text-[#E8580C] hover:underline text-sm">
            Xóa bộ lọc
          </button>
        </div>
      </aside>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600">
                  Tìm thấy <span className="font-semibold text-[#E8580C]">{jobs.length}</span> công việc
                </p>
              </div>
            </div>
            ...
            {jobs.map((job) => (
              <div
                ...
                className={`bg-white rounded-xl p-6 border-2 cursor-pointer transition-all ${
                  selectedJob === job.id
                    ? "border-[#E8580C] shadow-lg"
                    : "border-gray-100 hover:border-gray-300"
                }`}
              >
                <div className="flex gap-4">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] rounded-xl flex items-center justify-center text-2xl flex-shrink-0">
                    {job.logo}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4 mb-2">
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold mb-1 hover:text-[#E8580C] transition-colors">
                          {job.title}
                        </h3>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        <DollarSign className="w-4 h-4 text-[#E8580C]" />
                        <span className="font-semibold text-[#E8580C]">{job.salary}</span>
                      </div>
                      <div className="flex items-center gap-1">
            ...
            <div className="w-1/2 border-l border-gray-200 bg-white overflow-y-auto">
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#E8580C] to-[#ff7a3d] rounded-xl flex items-center justify-center text-3xl">
                ...
                <div className="flex gap-3">
                  ...
                  <button className="px-4 py-3 border-2 border-gray-300 rounded-xl hover:border-[#E8580C] hover:bg-[#FFF3ED] transition-all">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="font-semibold text-[#E8580C]">{selectedJobData.salary}</p>
                    </div>
                    <div>
