...
*Lưu ý: Mặc định các file ví dụ đã được cấu hình để chạy được ngay với Docker.*
...
- Làm chức năng mới 
    - feature/Tên_của_mình/FE_moduleName
...
---
*Dự án đang trong quá trình phát triển. Chúc team làm việc hiệu quả!*
