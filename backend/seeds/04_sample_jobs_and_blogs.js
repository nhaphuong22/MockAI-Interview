  ...
  await knex('job_posts').insert([
    {
      ...
      description: 'Gia nhập đội ngũ phát triển sản phẩm cốt lõi, xây dựng giao diện người dùng tương tác cao cho nền tảng giáo dục triệu người dùng. Cơ hội làm việc trực tiếp với các chuyên gia UI/UX hàng đầu.',
    ...
    },
    {
      ...
      description: 'Nghiên cứu và triển khai các mô hình AI tiên tiến (Llama 3, GPT-4o) vào các sản phẩm thực tế. Tham gia thiết kế kiến trúc RAG chuyên sâu cho hệ thống phân tích dữ liệu lớn.',
    ...
    },
    {
      ...
      description: 'Dẫn dắt chiến lược tăng trưởng người dùng (User Acquisition) cho các nền tảng công nghệ số. Chịu trách nhiệm trực tiếp về các chỉ số CAC và LTV.',
    ...
    },
    {
      ...
      description: 'Thiết kế và xây dựng hệ thống Microservices chịu tải cao (High Availability). Tối ưu hóa Database và cải thiện hiệu năng API từ millisecond xuống microsecond.',
    ...
    },
    {
      ...
      description: 'Làm việc trực tiếp với ban giám đốc để định hình tầm nhìn sản phẩm tài chính số. Quản lý vòng đời sản phẩm từ khâu ý tưởng đến khi ra mắt (Go-to-market).',
